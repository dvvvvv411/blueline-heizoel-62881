...
const USPSection = () => {
  ...
  const stats = [
    { icon: TrendingDown, value: "100.000+", label: "Zufriedene Kunden", color: "text-[#48dbfb]" },
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-[#e8f9fd]/30 to-white relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(72,219,251,0.06),transparent)]"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20">
          {usps.map((usp, index) => {
            ...
            return (
              <div 
                key={index}
                className="group relative bg-white/80 backdrop-blur-md border border-[#b3f0ff]/50 rounded-3xl p-8 shadow-md hover:shadow-2xl hover:shadow-[#48dbfb]/10 hover:bg-white/90 hover:backdrop-blur-lg transition-all duration-700 hover:-translate-y-2 animate-fade-in"
        ...
        {/* Stats Section */}
        <div className="bg-white/85 backdrop-blur-md rounded-3xl border border-[#b3f0ff]/50 p-8 md:p-12 shadow-md">
