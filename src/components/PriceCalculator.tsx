...
const PriceCalculator = () => {
  ...
  const handleOrder = async () => {
    ...
    const orderData: OrderData = {
      shop_id: "2bb97045-40c6-4879-a1a6-cfda3ef5230f",
  ...
  return (
    <div id="price-calculator" className="glassmorphism-card p-8 animate-scale-in max-w-5xl mx-auto">
      ...
      <div className="grid lg:grid-cols-2 gap-8 items-stretch">
        ...
        <div className="flex flex-col h-full space-y-6">
          {/* Price Breakdown */}
          <div className="flex-1 flex flex-col bg-white/75 border border-[#b3f0ff]/50 rounded-xl p-6 space-y-4 shadow-sm">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <span className={`font-semibold whitespace-nowrap ${deliveryFee === 0 ? 'text-[#48dbfb]' : ''}`}>
            ...
            {deliveryFee === 0 && (
              <div className="bg-[#e8f9fd] text-[#2698b8] px-3 py-2 rounded-lg text-sm font-medium text-center">
            ...
            <div className="border-t pt-4">
              ...
              <p className="text-4xl font-extrabold text-[#48dbfb] whitespace-nowrap mt-1">{totalPrice.toFixed(2)} €</p>
          ...
          <div className="mt-auto">
            <Button 
              ...
              className="w-full bg-[#48dbfb] hover:bg-[#38b9e0] text-white text-lg py-6 rounded-xl font-semibold transition-all hover-scale"
            >
              {isProcessing ? (
                <div className="flex items-center space-x-2">
