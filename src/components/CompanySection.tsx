...
const CompanySection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-[#e8f9fd]/30 to-[#d8f5fc]/20 relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(72,219,251,0.06),transparent)]"></div>
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          {/* Company Info */}
          <div className="animate-fade-in">
            <div className="inline-block bg-[#48dbfb]/10 text-[#2698b8] px-6 py-2 rounded-full text-sm font-semibold mb-6">
              Über uns
            </div>
            ...
            <div className="space-y-6 text-lg text-gray-600 leading-relaxed mb-12">
              <p>
                Seit 1990 Ihr verlässlicher Partner für Premium-Heizöl aus Hannover. 
                Mit über 35 Jahren Erfahrung und Expertise beliefern wir Privat- und 
              ...
              <p>
                ...
                <span className="font-semibold text-[#2698b8]"> Premium Heizöl ab 70 Cent pro Liter</span> – von Hannover nach ganz Deutschland geliefert.
              </p>
              
              <p>
                Unser Versprechen seit 1990: Transparente Preise, bewährter Premium-Service 
                und kostenlose Lieferung ab 2.000 Litern deutschlandweit. 
                35 Jahre Erfahrung, über 100.000 zufriedene Kunden in ganz Deutschland – 
            ...
            <div className="grid grid-cols-2 gap-4">
              {qualityFeatures.map((feature, index) => {
                ...
                return (
                  <div 
                    key={index}
                    className="group bg-white/80 backdrop-blur-md border border-[#b3f0ff]/50 rounded-2xl p-6 shadow-md hover:shadow-lg hover:-translate-y-1 hover:bg-white/90 transition-all duration-500 animate-fade-in"
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.3s' }}>
            {/* Contact Card */}
            <div className="bg-white/85 backdrop-blur-md border border-[#b3f0ff]/50 rounded-3xl p-8 mb-8 shadow-md hover:shadow-xl hover:bg-white/93 transition-all duration-500">
