...
const UeberUns = () => {
  return (
    <div className="min-h-screen">
      <SEO
        title="Über uns & Service | Hackmann-Heizöl | Premium Heizöl-Händler"
        description="Hackmann-Heizöl – Ihr vertrauensvoller Partner für Heizöl. Innovatives Unternehmen aus Hannover mit über 100.000 zufriedenen Kunden deutschlandweit."
        keywords="Hackmann-Heizöl, Hannover, Heizöl Unternehmen, Premium Heizöl"
        canonicalUrl="https://hackmann-heizoel.de/ueber-uns"
      />
      <Header />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Ihr vertrauensvoller Partner für Heizöl in Hannover und ganz Deutschland. 
      ...
      <PageSection className="py-24" background="warm">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Hackmann-Heizöl</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Ihre vertrauensvolle Adresse für Premium-Heizöl aus Hannover
            </p>
          </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Seit 1990 sind wir Ihr vertrauensvoller Partner für Premium-Heizöl in Hannover 
                    und ganz Deutschland. Mit über 35 Jahren Erfahrung und Expertise haben wir uns 
                    als einer der führenden Heizöl-Händler etabliert. Was vor über drei Jahrzehnten 
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Unser Erfolgsrezept seit 1990: Die perfekte Kombination aus über 35 Jahren 
                    Erfahrung, persönlicher Betreuung und modernster Technik. Transparente Preise 
                    und absolute Zuverlässigkeit – Werte, die seit über drei Jahrzehnten Bestand haben. 
              ...
              <div className="relative bg-white/85 backdrop-blur-md border border-[#b3f0ff]/50 rounded-3xl p-10 shadow-lg hover:shadow-xl hover:bg-white/93 transition-all duration-300">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-4 bg-gray-50 rounded-xl">
                    ...
                    <span className="font-bold text-primary text-lg">1990</span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-primary/5 rounded-xl border border-primary/20">
                    ...
                    <span className="font-bold text-gray-900">Hannover</span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="flex justify-between items-center p-4 bg-gradient-to-r from-[#e8f9fd] to-[#d8f5fc] rounded-xl border-2 border-[#b3f0ff]">
                    ...
                    <span className="font-bold text-[#2698b8] text-xl">35+ Jahre</span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-gray-50 rounded-xl">
      ...
      <PageSection background="primary" className="py-24">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Ihre Ansprechpartner in Hannover - wir sind für Sie da
            </p>
          </div>
          ...
          <div className="relative bg-white/85 border border-red-200/50 rounded-3xl p-10 shadow-lg backdrop-blur-md hover:shadow-xl hover:bg-white/93 transition-all duration-300">
                ...
                <div className="space-y-6 text-center">
                  <div className="p-4 bg-white/60 rounded-xl border border-white/40">
                    <p className="font-bold text-lg text-gray-900 mb-2">Hackmann-Heizöl (Hackmann & Comp. GmbH)</p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white/85 border border-red-200/50 rounded-3xl p-10 shadow-lg backdrop-blur-md hover:shadow-xl hover:bg-white/93 transition-all duration-300">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-white/60 rounded-xl border border-white/40">
                    <p className="text-gray-700"><strong className="text-primary">Gründung:</strong> 1990</p>
                  </div>
